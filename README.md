...
Persona 2: Innocent Sin n'a jamais été officiellement localisé en français. Ce projet est une traduction amateur complète, développée par une équipe de passionnés, couvrant les dialogues, les menus, les cinématiques, et l'interface graphique de la version PSP européenne.

Le dépôt centralise le patch jouable, les outils de romhacking développés sur-mesure pour ce moteur, et la documentation technique complète du jeu.
...
Toute la chaîne de traduction repose sur des outils développés en interne, car aucun outil existant ne gérait les particularités du moteur Atlus PSP.
...
| **pspdecrypt** (John-K) | Déchiffrement EBOOT, appelé en externe | Open-Source |
