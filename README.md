...
> 
> *Création de mods et traductions dérivées :* Si vous souhaitez utiliser nos outils ou notre traduction pour créer votre propre version (ex: traduction en portugais, modifiant le jeu), vous en avez le droit à condition de **créditer l'équipe originale** et de **distribuer votre projet sous cette même licence exacte** (ShareAlike).
